#line 1 "C:\\Users\\emanu\\OneDrive\\Documenti\\CamplusProgettoLibreriaTFTDebug1\\CamplusUI-TFT-Documentato\\src\\LargeEvent.cpp"
#include "Event.h"
...
void LargeEvent::addListener(void (*listener)(void* args), void* arguments)
{
    if(lastListenerIndex < MAXIMUM_LISTENERS - 1)
    {
        lastListenerIndex++;
        listeners[lastListenerIndex] = listener;
        LargeEvent::args[lastListenerIndex] = arguments;
    }
    else
    {
...
void LargeEvent::addListener(void (*listener)(void* args))
{
    if(lastListenerIndex < MAXIMUM_LISTENERS - 1)
    {
        lastListenerIndex++;
...
void LargeEvent::removeListener(void (*listener)(void* args)) 
{
    int i = 0;
